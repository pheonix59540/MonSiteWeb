...
def generate_html(data):
    ...
    <html lang="fr">
        ...
        <p>Cette pièce est issue du travail exceptionnel des créateurs de <strong>The Lost Kingdom Miniatures</strong> et s'inscrit parfaitement dans l'univers mystique et sauvage des <strong>Elfes Mori</strong>.</p>
