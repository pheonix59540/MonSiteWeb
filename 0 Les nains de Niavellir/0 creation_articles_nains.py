...
def generate_html(data):
    ...
    <html lang="fr">
        ...
        <h2>Les <strong>Nains de Niavellir</strong>, Forgeurs indomptables et guerriers ancestraux pour vos armées !</h2>
        <p>Découvrez <strong>{titre}</strong>, une magnifique figurine imprimée en <strong>résine de haute qualité</strong>. Ces pièces uniques, dotées d'un design original et puissant, sont conçues pour apporter une présence inégalée et une robustesse inébranlable à vos armées fantastiques sur le champ de bataille.</p>
        <p>Issus du travail exceptionnel des sculpteurs de  <strong>The Lost Kingdom Miniatures</strong> ces Duardins s'inscrivent dans un univers où la fureur ancestrale et la maîtrise de la forge se mêlent. Chaque détail, des lourdes armures runiques aux barbes tressées avec soin, capture l'essence de ces guerriers nains comme <strong>vous ne les avez jamais vus. </strong></p>
        <p>Cette figurine est livrée non-peinte et non-assemblée, prête à être personnalisée pour donner vie à votre vision d'une force naine implacable et légendaire.</p>
      </div>
      ...
      <div class="contact-cta">
        <p>Envie de découvrir plus de créations issues de l'univers des <strong>Nains de Niavellir</strong> par The Lost Kingdom Miniatures, ou d'autres figurines fantastiques en résine ?</p>
