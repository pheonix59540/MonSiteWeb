...
def generate_html(data):
    ...
    <html lang="fr">
        ...
        <h2>La Cruauté Raffinée : Les Elfes Noirs, Maîtres des Ombres et de la Douleur !</h2>
        <p>Découvrez  <strong>{titre}</strong>, imprimée avec une précision glaçante en <strong>résine de haute qualité</strong>. Ces créations captivent par leur esthétique mordante, leur grâce létale et l'aura de danger qu'elles dégagent. Chaque pièce est un témoignage de l'art du sacrifice et de la soif de pouvoir.</p>
        <p>Issues de la vision audacieuse des sculpteurs <strong>de Lost Kingdom Miniatures</strong>. Qu'ils soient issus des profondeurs des cités obscures de Naggaroth ou des rivages ensanglantés de leurs cultes, ces guerriers et sorcières incarnent la force impitoyable et la beauté vénéneuse. Chaque détail est sculpté avec une finesse exquise : des armures barbelées aux lames aiguisées comme des rasoirs, des capes flottantes aux expressions glaciales de leurs visages. Leurs cavaliers sur Sang-Froids ou les créatures volantes comme les Manticores ajoutent une dimension spectaculaire et mortelle à toute armée.</p>
        <p>Cette figurine est livrée non-peinte et non-assemblée, , vous offrant la toile parfaite pour les personnaliser et libérer leur <strong>potentiel destructeur.</strong></p>
      </div>
      ...
      <div class="contact-cta">
        <p>Envie de découvrir plus de créations issues de l'univers des <strong>Elfes Noirs</strong> par The Lost Kingdom Miniatures, ou d'autres figurines fantastiques en résine ?</p>
