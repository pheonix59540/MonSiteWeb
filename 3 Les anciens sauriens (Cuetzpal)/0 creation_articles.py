...
def generate_html(data):
    ...
    <html lang="fr">
        ...
        <p>Plongez au cœur de l'action avec <strong>{titre}</strong>, une pièce maîtresse de notre gamme <strong>La Forêt Magique</strong>, conçue pour les passionnés de jeux fantastiques comme <strong>Warhammer Age of Sigmar, The Old World, 9th Age, Kings of War </strong>, et bien d'autres !</p>
